...
async function main() {
  ...
  const jsonContent = fs.readFileSync(path.join(__dirname, 'seed.json'), 'utf-8')
  ...
  for (const template of templates) {
    const createdTemplate = await prisma.contractTemplate.upsert({
      ...
      create: {
        ...
        price: template.type === 'SALE' ? 49.99 : 29.99,
        steps: {
          create: template.type === 'RENT' ? [
            {
              step: 1,
              title: { pt: "Selecionar Tipo", en: "Select Type" },
              description: { pt: "Escolha o tipo de contrato", en: "Choose contract type" }
            },
            {
              step: 2,
              title: { pt: "Partes", en: "Parties" },
              description: { pt: "Preencha os dados do senhorio e inquilino", en: "Fill landlord and tenant data" }
            },
            {
              step: 3,
              title: { pt: "Imóvel", en: "Property" },
              description: { pt: "Selecione o imóvel", en: "Select the property" }
            },
            {
              step: 4,
              title: { pt: "Detalhes", en: "Details" },
              description: { pt: "Preencha os detalhes do contrato", en: "Fill contract details" }
            },
            {
              step: 5,
              title: { pt: "Revisão", en: "Review" },
              description: { pt: "Revise o contrato", en: "Review the contract" }
            }
          ] : [
            {
              step: 1,
            ...
            },
            {
              step: 2,
              title: { pt: "Partes", en: "Parties" },
              description: { pt: "Preencha os dados do vendedor e comprador", en: "Fill seller and buyer data" }
            },
            {
              step: 3,
              title: { pt: "Imóvel", en: "Property" },
  ...
  console.log({ contact1, contact2, property })
}
