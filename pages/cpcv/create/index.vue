    ...
    >
      <div class="flex flex-col">
        ...
        <span class="text-gray-400"
          >Crie documentos de CPCV com facilidade. Preencha os campos abaixo e
          clique em "Criar CPCV" para gerar o documento.</span
        >
      </div>
      <form class="pt-4" @submit.prevent="generateDocument">
        ...
        <div class="flex flex-col gap-2 mt-4">
          ...
          <Input
            ...
            class="Input"
          />
          <Label>Número de Licença de Utilização da Primeira Cláusula</Label>
          <Input
            v-model="payload.clauses.values.firstClauseLicenseUtilizationNumber"
            type="text"
          ...
          <Input
            ...
            class="Input"
          />
          <Label>Número de Certificação Energética da Primeira Cláusula</Label>
          <Input
            v-model="
          ...
          <Input
            v-model="
              payload.clauses.values.firstClauseEnergyCertificationValidUntil
            "
            type="date"
            placeholder="Validade da Certificação Energética da Primeira Cláusula"
            class="Input"
          />
          <Label>Letra da Certificação Energética da Primeira Cláusula</Label>
          <Input
            v-model="
            ...
            class="Input"
          />
          <Label>Extra da Certificação Energética da Primeira Cláusula</Label>
          <Input
            v-model="payload.clauses.values.firstClauseEnergyCertificationExtra"
            type="text"
          ...
          <Input
            v-model="payload.clauses.values.secondClauseEquipmentsInTheProperty"
            type="text"
